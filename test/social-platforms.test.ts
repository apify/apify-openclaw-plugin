...
function withFetchPreconnect<T extends (...args: never[]) => unknown>(fn: T): T & typeof fetch {
  return Object.assign(fn, {
    preconnect: (_url: string | URL, _options?: Record<string, boolean>) => {},
  }) as T & typeof fetch;
}
...
function setupMockFetch(items: unknown[] = []) {
  ...
  global.fetch = withFetchPreconnect(mockFetch) as unknown as typeof fetch;
  return mockFetch;
}
